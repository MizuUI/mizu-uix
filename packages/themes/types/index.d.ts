 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@mizuuix/styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@mizuuix/styled` instead.
